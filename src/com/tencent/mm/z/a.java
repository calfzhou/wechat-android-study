...
public final class a
{
  public static int gW(String paramString)
  {
    ...
    {
      z.e("!24@cGB/4jtGxPuGiNjOv8QAsA==", "getStrokesCount buffer is empty");
      return 0;
    }
    label901: 
    while (true)
    {
      ...
      try
      {
        byte[] arrayOfByte = paramString.getBytes("big5");
        if ((arrayOfByte != null) && (arrayOfByte.length >= 2))
          break label901;
        z.e("!24@cGB/4jtGxPuGiNjOv8QAsA==", "byteToShort");
        i = 0;
        break label887;
        if (j < 2)
        {
