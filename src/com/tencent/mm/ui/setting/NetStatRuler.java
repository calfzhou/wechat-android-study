...
class NetStatRuler extends View
{
  ...
  public void onDraw(Canvas paramCanvas)
  {
    ...
    paramCanvas.drawText(ap.aa(2 * NetStatUnit.max / 3), f2, f3, localTextPaint);
    paramCanvas.drawText(ap.aa(NetStatUnit.max / 3), f2, f4, localTextPaint);
    paramCanvas.drawText(ap.aa(0L), f2, f5, localTextPaint);
  }
}
