...
public final class ab
{
  ...
  public static String a(m paramm, List paramList)
  {
    if (paramm == null)
      return "[]";
    StringBuilder localStringBuilder = new StringBuilder();
    ...
    int i = paramm.b;
    int j = paramm.KZ;
    boolean bool = b(paramm.a, i, j, paramm.La, paramm.LL);
    int k = 0;
    if (bool)
    {
      localStringBuilder.append(a(i, j, paramm.La, paramm.LL, paramm.LM, paramm.g, paramm.LN));
      k = 1;
    }
    if (paramList != null);
    while (true)
    {
      try
      {
        ...
        if (localIterator.hasNext())
        {
          ...
          if (!b(paramm.a, i, j, m, localNeighboringCellInfo.getCid()))
            break label274;
          if (k > 0)
            localStringBuilder.append(",");
  ...
  public static String b(q paramq)
  {
    if (paramq.ha() == null)
      return "{}";
    Location localLocation = paramq.ha();
    StringBuilder localStringBuilder = new StringBuilder();
    localStringBuilder.append("{");
  ...
  public static String b(z paramz)
  {
    if ((paramz == null) || (paramz.gY() == null))
      return "[]";
    StringBuilder localStringBuilder = new StringBuilder();
    localStringBuilder.append("[");
    if ((paramz.gY() == null) || (paramz.gY().size() <= 0))
    {
      localStringBuilder.append("]");
      return localStringBuilder.toString();
    }
    List localList = paramz.gY();
    Iterator localIterator = localList.iterator();
    int i = 0;
    label130: label215: label219: 
  ...
  public static boolean b(int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5)
  {
    ...
    while ((paramInt5 != 65535) && (paramInt5 > 0));
    return false;
  }
 ...
 * Qualified Name:     com.tencent.map.location.ab
