...
public final class xl extends com.tencent.mm.ao.a
{
  public String Ks;
  public String Kt;
  public int dtf;
  ...
  public static boolean a(b.a.a.a.a parama, xl paramxl, int paramInt)
  {
    switch (paramInt)
    {
    default:
    ...
    case 2:
      ...
      for (int m = 0; m < k; m++)
      {
        ...
        paramxl.ifj = localvt1;
      }
      return true;
    case 3:
      paramxl.dtf = parama.bel();
      return true;
    case 4:
      paramxl.Ks = parama.ben();
      return true;
    case 5:
      paramxl.Kt = parama.ben();
      return true;
    case 6:
      paramxl.dtg = parama.ben();
      return true;
    case 7:
      paramxl.dth = parama.bel();
      return true;
    case 8:
      paramxl.ifO = parama.bel();
      return true;
    case 9:
      paramxl.ifP = parama.ben();
      return true;
    case 10:
      paramxl.ifQ = parama.ben();
      return true;
    case 11:
      paramxl.dti = parama.ben();
      return true;
    case 12:
      paramxl.ifR = parama.ben();
      return true;
    case 13:
      paramxl.ifS = parama.bel();
      return true;
    case 14:
      paramxl.dtm = parama.ben();
      return true;
    case 15:
      ...
      for (int j = 0; j < i; j++)
      {
        ...
        for (boolean bool1 = true; bool1; bool1 = ew.a(locala1, localew, locala1.bet()));
        paramxl.irC = localew;
      }
      return true;
    case 16:
      paramxl.hTy = parama.ben();
      return true;
    case 17:
    }
    paramxl.hTz = parama.ben();
    return true;
  }
 ...
 * Qualified Name:     com.tencent.mm.protocal.a.xl
