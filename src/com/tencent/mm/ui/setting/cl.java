...
{
  cl(SettingsChattingUI paramSettingsChattingUI, LinearLayout paramLinearLayout, float paramFloat)
  {
  }
  ...
  public final void onClick(View paramView)
  {
    ...
    z.d("!44@/B4Tb64lLpJkrm2DE1IrT0rq7ozlS8hfaamGM7cAkVA=", "select size %f", arrayOfObject);
    if (this.jMm == f)
      return;
    paramView.post(new cm(this, f));
  }
}
