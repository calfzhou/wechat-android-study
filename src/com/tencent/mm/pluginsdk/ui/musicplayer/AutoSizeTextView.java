...
public class AutoSizeTextView extends TextView
{
  ...
  private void ad(String paramString, int paramInt)
  {
    ...
    z.i("!44@/B4Tb64lLpI78mCshwBkxFNiB+JaH5FkQ+K395YCEeo=", "autoAdjustTextSize[text=%s, viewWidth=%d]", arrayOfObject1);
    if (paramInt <= 0)
      return;
    ...
    while (true)
    {
      ...
      else
      {
        ...
        z.i("!44@/B4Tb64lLpI78mCshwBkxFNiB+JaH5FkQ+K395YCEeo=", "try size[%f], maxSize[%f], measureTextSize[%f], availableWidth[%d]", arrayOfObject2);
        setTextSize(0, f);
        return;
      }
      this.hFy.setTextSize(f);
  ...
  {
    z.w("!44@/B4Tb64lLpI78mCshwBkxFNiB+JaH5FkQ+K395YCEeo=", "on size changed");
  ...
  {
    z.w("!44@/B4Tb64lLpI78mCshwBkxFNiB+JaH5FkQ+K395YCEeo=", "on text changed");
