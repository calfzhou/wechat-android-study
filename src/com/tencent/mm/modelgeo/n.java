...
public abstract class n extends b
{
  ...
  public final void a(d paramd)
  {
    ...
    z.i("!44@/B4Tb64lLpJfn8anhv+Gj4lPDE5/r0LjjEGFhWg+aVE=", "lat=%f, lng=%f, accuracy=%f errcode=%d, info=%d, speed=%f, loctype=%d", arrayOfObject);
    if (paramd.Lj == 0)
    {
  ...
  public final void a(byte[] paramArrayOfByte, int paramInt)
  {
    ...
    z.d("!44@/B4Tb64lLpJfn8anhv+Gj4lPDE5/r0LjjEGFhWg+aVE=", "onLocationDataUpdate, status=%d", arrayOfObject);
  }
  ...
  public final void aQ(int paramInt)
  {
    ...
    Object[] arrayOfObject = new Object[1];
    arrayOfObject[0] = Integer.valueOf(paramInt);
    z.d("!44@/B4Tb64lLpJfn8anhv+Gj4lPDE5/r0LjjEGFhWg+aVE=", "onStatusUpdate, status=%d", arrayOfObject);
  }
}

/* Location:           /Users/zhouji/projects/wechat-android-study/classes_dex2jar.jar
 * Qualified Name:     com.tencent.mm.modelgeo.n
