...
public final class d
{
  ...
  public static byte[] DQ(String paramString)
  {
    try
    {
  ...
  public static byte[] dn(byte[] paramArrayOfByte)
  {
  ...
  private boolean md5Update(java.io.InputStream paramInputStream, long paramLong)
  {
    ...
    //   110: iconst_0
    //   111: iload 10
    //   113: invokevirtual 271	java/io/InputStream:read	([BII)I
    //   116: pop
    //   117: aload_0
    ...
    //   125: iconst_0
    //   126: iload 10
    //   128: invokestatic 261	oicq/wlogin_sdk/c/d:md5Memcpy	([B[BIII)V
    //   131: aload_0
    //   132: aload_0
    //   133: getfield 24	oicq/wlogin_sdk/c/d:buffer	[B
    //   136: invokespecial 263	oicq/wlogin_sdk/c/d:md5Transform	([B)V
    //   139: iload 10
    //   141: istore 18
    //   143: iload 18
    //   145: bipush 63
    ...
    //   171: aload_1
    //   172: aload 12
    //   174: invokevirtual 274	java/io/InputStream:read	([B)I
    //   177: pop
    //   178: aload_0
    ...
    //   187: aload 12
    //   189: arraylength
    //   190: invokestatic 261	oicq/wlogin_sdk/c/d:md5Memcpy	([B[BIII)V
    //   193: iconst_1
    //   194: ireturn
    //   195: aload_1
    //   196: aload 4
    //   198: invokevirtual 274	java/io/InputStream:read	([B)I
    //   201: pop
    //   202: aload_0
    //   203: aload 4
    //   205: invokespecial 263	oicq/wlogin_sdk/c/d:md5Transform	([B)V
    //   208: iinc 18 64
    //   211: goto -68 -> 143
    //   214: iconst_0
    //   215: istore 11
