  ...
  implements b
{
  ...
  public final y J(int paramInt1, int paramInt2)
  {
    ...
    try
    {
      ...
      z.d("!44@/B4Tb64lLpKbU59mf71RZFzMaOEttCECeZZozT7o7i8=", "DBG: ReadFile[" + this.rI + "] readOffset:" + paramInt1 + " readRet:" + i + " fileNow:" + this.dAK.getFilePointer() + " fileSize:" + l);
      if (i < 0)
        i = 0;
      localy.ddA = i;
    ...
    {
      z.e("!44@/B4Tb64lLpKbU59mf71RZFzMaOEttCECeZZozT7o7i8=", "ERR: ReadFile[" + this.rI + "] Offset:" + paramInt1 + "  failed:[" + localException.getMessage() + "] ");
      Bf();
      localy.ret = -1;
    }
    return localy;
  ...
  public final int write(byte[] paramArrayOfByte, int paramInt1, int paramInt2)
  {
    ...
    while (true)
    {
      ...
      {
        z.e("!44@/B4Tb64lLpKbU59mf71RZFzMaOEttCECeZZozT7o7i8=", "ERR: WriteFile[" + this.rI + "] Offset:" + paramInt2 + " failed:[" + localException.getMessage() + "]");
        Bf();
        return -3;
      }
      boolean bool3 = false;
