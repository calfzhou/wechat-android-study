  ...
  implements a, as
{
  ...
  private void IC()
  {
    ...
    {
      this.dXi.removeAll();
      this.dXi.addPreferencesFromResource(q.czy);
      ((HelperHeaderPreference)this.dXi.BU("contact_info_header_helper")).a(this.elz, this.jDW);
      ((CheckBoxPreference)this.dXi.BU("contact_info_voipaudio_sound_notify")).setChecked(bool);
      if (i == 0)
        break;
  ...
  private static boolean aXR()
  {
    try
    {
      boolean bool = ((Boolean)bg.qW().oQ().get(73218, Boolean.valueOf(true))).booleanValue();
      return bool;
    }
  ...
  public static void b(Context paramContext, boolean paramBoolean)
  {
    ...
    for (String str = paramContext.getString(n.cgw); ; str = paramContext.getString(n.cgC))
    {
      ...
      bw localbw = new bw(paramBoolean, null);
      new Timer().schedule(new bx(localcr, localbw), 1500L);
      return;
    }
  }
  ...
  public final void a(int paramInt, com.tencent.mm.sdk.f.ap paramap, Object paramObject)
  {
    ...
    z.d("!44@/B4Tb64lLpLSOpQlr7qYXXN1CK5uNaZzocTOiuJz1rI=", "onNotifyChange event:%d obj:%d stg:%s", arrayOfObject1);
    if ((paramap != bg.qW().oQ()) || (i <= 0))
    {
      arrayOfObject2 = new Object[2];
      arrayOfObject2[0] = Integer.valueOf(i);
      arrayOfObject2[1] = paramap;
      z.e("!44@/B4Tb64lLpLSOpQlr7qYXXN1CK5uNaZzocTOiuJz1rI=", "onNotifyChange error obj:%d stg:%s", arrayOfObject2);
    }
    while ((i != 40) && (i != 34) && (i != 7))
    {
  ...
  public final boolean a(o paramo, i parami, boolean paramBoolean, int paramInt)
  {
    ...
    for (boolean bool1 = true; ; bool1 = false)
    {
      ...
      Assert.assertTrue(y.dA(parami.getUsername()));
      bg.qW().oQ().a(this);
      this.elz = parami;
      this.dXi = paramo;
      IC();
  ...
  {
    z.d("!44@/B4Tb64lLpLSOpQlr7qYXXN1CK5uNaZzocTOiuJz1rI=", "handleEvent : key = " + paramString);
    ...
    {
      com.tencent.mm.ui.base.e.a(this.context, this.context.getString(n.cgz), "", this.context.getString(n.bsM), this.context.getString(n.bsK), new bv(this), null);
      return true;
    }
    z.e("!44@/B4Tb64lLpLSOpQlr7qYXXN1CK5uNaZzocTOiuJz1rI=", "handleEvent : unExpected key = " + paramString);
    return false;
  }
 ...
 * Qualified Name:     com.tencent.mm.ui.contact.profile.bu
